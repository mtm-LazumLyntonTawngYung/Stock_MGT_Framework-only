...
**Purpose:** ၀ယ်ထားသော stock နှင့်ပတ်သက်၍ ဝယ်စားရင်းများကို ကြည့်ရှုနိုင်ရန်၊ လစဥ်စျေးစားရင်းနှုန်းများနှင့် နှိုင်းယှဥ်မှုပြုလုပ်နိုင်ရန်၊ လုံးခြုံစိတ်ကြိုက်၊ အမျိုးအစား၊ ပစ္စည်းအမျိုးအစား နှင့် လစဥ်အလိုက် ရှာဖွေနိုင်ရန် လုပ်ဆောင်ပေးနိုင်ရမည်။
...
### Default 
- Default အနေနဲ့ဆို current month purchase ကိုပြပေးရမှာဖြစ်ပါတယ်။
